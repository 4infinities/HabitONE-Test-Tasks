...
Найширша метрика: 795 рядків (vs 573 для $/г). Більш надійна для міжбрендового порівняння, бо не залежить від `volume_g`. HabitONE: $1.28/порцію — 2-й найдешевший у peer set.
